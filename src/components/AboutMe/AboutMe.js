    ...
    return(
        <section className="aboutMe">
            ...
            <ul className="aboutMe__links">
                <li><Link className="aboutMe__link transition-link" to={{ pathname: "https://github.com/BrodoDigitale"}} target="_blank">Github</Link></li>
                <li><Link className="aboutMe__link transition-link" to={{ pathname: "https://www.linkedin.com/in/yulia-sensi/"}} target="_blank">LinkedIn</Link></li>
            </ul>
        </nav>
            </div>
