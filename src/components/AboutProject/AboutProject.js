    ...
    return(
        <section className="aboutProject">
            ...
            <ul className="aboutProject__description-table">
                <li>
                    <h3 className="aboutProject__description-header">Дипломный проект включал 5 этапов</h3>
                ...
                <li>
                <h3 className="aboutProject__description-header">На выполнение диплома ушло 5 недель</h3>
            ...
            <div className="aboutProject__timeline">
                <p className="aboutProject__timeline-cell aboutProject__timeline-cell_black">1 неделя</p>
                <p className="aboutProject__timeline-cell aboutProject__timeline-cell_grey">4 недели</p>
