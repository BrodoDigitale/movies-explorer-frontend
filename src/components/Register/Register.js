  ...
  return (
    <main className="register">
      ...
      <form className="register__form" onSubmit={handleSubmit}>
        ...
        <button className="register__button transition-button" type="submit">Зарегистрироваться</button>
        <Link className="register__link transition-link" to="/signin">
        Уже зарегистрированы? 
        <span className="register__link-span transition-link"> Войти</span>
        </Link>
        </div>
        </form>
      </AuthForm>
